package com.hyeok.joon.controller.common;
...
public class NaverLoginController {
  ...
  private String CLIENT_ID = "Jtke6HMGgour2cDVUjH1"; //애플리케이션 클라이언트 아이디값";
  private String CLI_SECRET = "Asj30koy33"; //애플리케이션 클라이언트 시크릿값";
  /**
   * 로그인 화면이 있는 페이지 컨트롤
   * @param session
   * @param model
